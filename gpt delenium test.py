...
def search_qdrant_and_summarize(query: str, top_k: int = 3, summary_sentences: int = 2) -> str:
    """
    ...
    try:
        ...
        return agent.search_and_summarize(query, top_k, summary_sentences)
    except Exception as e:
        logger.error(f"Error in search_qdrant_and_summarize: {e}")
